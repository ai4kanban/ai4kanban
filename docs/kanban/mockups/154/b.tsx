// Layout B — one "Links" column carrying the whole dependency sentence: what
// this card waits on and what waits on it, in one line. Card page, 1280x800.
        ...
        <div className="min-w-0 flex-1 pl-1">
          <div className="h-full overflow-hidden rounded-tl-[14px] bg-white">
            <main className="mx-auto w-full max-w-[840px] px-6 py-6">
              ...
              {/* the meta band — one "Links" column says both directions at once */}
              <div className="mb-4 flex flex-wrap items-start gap-x-7 gap-y-3 rounded-[14px] border-[1.5px] bg-white px-4 py-3"
                ...
                <Meta label="Links">
                  <span className="text-[10px] font-[700] uppercase tracking-[0.04em]" style={{ color: SOFT }}>waits on</span>
                  <Chip bg={PEACH_SOFT} fg={PEACH_INK}><Lock color={PEACH_INK} />#63</Chip>
                  <span className="text-[11px]" style={{ color: SOFT }}>·</span>
                  <span className="text-[10px] font-[700] uppercase tracking-[0.04em]" style={{ color: SOFT }}>holds up</span>
