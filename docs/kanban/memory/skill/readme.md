...
- A question with choices is written as options the user ticks, not as prose with the choices inside the line — `--options "a | b" --pick one|many --recommend 1`: `skill/references/resolve.md`.
