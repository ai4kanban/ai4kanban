...
//
// This module is the one parser, ported verbatim into the local UI
// (`kanban-ui/lib/cadence.ts`) so the script and the server read a card the same
// way. Times are the server's own local time — the board is a local tool, and
// there is no other clock to pick.
 ...
 * with it.
 */
export function nextDue(lastRun, cadence) {
...
export function isDue(lastRun, cadence, now = new Date()) {
