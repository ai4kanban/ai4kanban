...
export function stripReadmeRefs(target) {
...
export const readmeHeadingFor = (track) => (track === 'blockers' ? 'Blockers' : track)
...
export function addReadmeRef(track, id, title, relPath) {
...
export function repointReadmeLink(id, oldRel, newRel, title) {
  if (!fs.existsSync(README)) return false
