...
export { SKILL_SENTENCE, RAW_ARGS_KEY, MODEL_KEY, namesFlag, type Harness, type ImageInput, type LoginProbe, type RunFailure, type TransientFailure } from './types'
...
export const HARNESSES: Harness[] = [CLAUDE_CODE, CODEX, CURSOR, OPENCODE, KIMI, DSH, ZCODE, GROK].map(
  withRawArgs,
)
