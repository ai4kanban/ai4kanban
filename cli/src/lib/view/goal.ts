...
// and nobody has judged it yet, and it is what a save seeds. Nothing asks the user for a
// goal on the strength of it (#437): the goal is optional, and a board that nags for one
// is a board holding up work over a file nobody has to write.
//
 ...
 *  straight away, not after the next agent run. It is the whole of what a front end asks
 *  about the goal now (#437): the header's star opens what is written, and offers an empty
 *  box where nothing is. */
 ...
 *  it yet. The next run that reads the goal judges it. */
