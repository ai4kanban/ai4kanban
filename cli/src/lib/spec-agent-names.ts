...
// other: `lib/spec-agents.ts` is the roster, and `lib/agent/runtime.ts` reads one agent's
// saved runtime out of the board's file before any of that roster is loaded.
