...
- **`memory/writing.md`**: writing preferences no topic file covers, learned from user feedback.
- **`memory/writing/*.md`**: one topic each — `seo.md`, `voice.md`, `structure.md`; each stands alone.
