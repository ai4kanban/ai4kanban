...
const zh: DesktopCopy = {
  ...
  dialog: {
    ...
    update: {
      ...
      downloading: "AI4Kanban 正在后台下载新版本。下载完成后会提示你重启。",
      ready: (version) => `AI4Kanban ${version} 已下载完成。`,
      readyDetail: "重启会关闭 AI4Kanban 并打开新版本。",
      restart: "重启更新",
      later: "稍后",
      close: "关闭",
  ...
  update: {
    reason: {
      ...
      server: "更新服务暂时不可用。",
      disk: "磁盘空间不足，无法下载更新。",
      permission: "AI4Kanban 没有写入更新所需的权限。",
      checksum: "下载的更新包未通过完整性校验，已丢弃。",
      readOnly: "AI4Kanban 位于只读位置，无法自动更新。",
      noBuild: "这个版本没有适配这台电脑的安装包。",
      notInstallable: "这份 AI4Kanban 副本无法自动更新。",
      unknown: "更新未能安装。",
    },
  },
  project: {
