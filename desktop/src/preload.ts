...
const bridge: Ai4kanbanBridge = {
  ...
  openProjectWindow: (dir) => ipcRenderer.invoke(CHANNELS.openProjectWindow, dir),
  openBoard: (dir) => ipcRenderer.invoke(CHANNELS.openBoard, dir),
  openBoardWindow: (dir) => ipcRenderer.invoke(CHANNELS.openBoardWindow, dir),
  ...
  pickLocation: (from) => ipcRenderer.invoke(CHANNELS.pickLocation, from),
  ...
  cloudAccount: () => ipcRenderer.invoke(CHANNELS.cloudAccount),
  cloudSignIn: () => ipcRenderer.invoke(CHANNELS.cloudSignIn),
  cloudSignOut: () => ipcRenderer.invoke(CHANNELS.cloudSignOut),
  cloudRequestInvite: () => ipcRenderer.invoke(CHANNELS.cloudRequestInvite),
  cloudWorkspaces: () => ipcRenderer.invoke(CHANNELS.cloudWorkspaces),
  cloudGo: (request) => ipcRenderer.invoke(CHANNELS.cloudGo, request),
  cloudCommit: (dir) => ipcRenderer.invoke(CHANNELS.cloudCommit, dir),
  discardBoard: () => ipcRenderer.invoke(CHANNELS.discardBoard),
