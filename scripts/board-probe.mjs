...
run(['create', '--count', '2'])
run(['create', '--count', '0'])
run(['create', '--title', 'A first card', '--priority', 'high', '--modules', 'skill'])
run(['create', '--title', 'A second card', '--question', 'what should it do?'])
run(['create', '--title', 'No track'])
run(['create', '--priority', 'high'])
run(['list'])
...
run(['update-questions', '5', '--append', 'a second question', '--recommended-option', 'yes — the cheap one', '--option', 'no — leave it'])
run(['update-questions', '5', '--append', 'a bare question'])
run(['update-questions', '5', '--append', 'one choice only', '--option', 'yes'])
run(['update-questions', '5', '--append', 'a single-select one', '--option', 'a', '--option', 'b', '--mode', 'single'])
