...
// Delivery (#303, #308) is two switches. Runs (#394) is the silence limit. Language (#334)
// is one control. A pane each was a sidebar you had to walk to find anything; one pane shows
// all of it at a glance, and each group's caption is the whole of its explanation.
//
