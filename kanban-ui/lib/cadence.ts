...
//
// The parser itself is NOT here. It is skill/lib/cadence.mjs, copied to
// ./format/cadence.mjs by scripts/sync-format.mjs, so the script that writes a
// cadence and the server that acts on one cannot read it differently. This file
// is the name the UI imports it under — fix the rules in skill/lib/.
//
...
export {
  ...
  nextDue,
  isDue,
} from "./format/cadence.mjs";

export type { Cadence, CadenceUnit } from "./format/cadence.mjs";
