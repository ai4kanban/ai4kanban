...
const zh: SetupCopy = {
  ...
  firstRun: {
    ...
    agent: {
      ask: "由哪个 Agent 来干活？",
      blurb: "接下来由它读你的仓库、和你对话。在你选定之前，不会运行任何东西。",
      test: "测试并继续",
      testNote: (agent) => `向 ${agent} 发一次请求，确认它已登录。`,
      answered: "已回答 —— 继续。",
    },
    reading: {
      ask: "正在读你的仓库。",
      blurb: "最多一分钟。读完我会告诉你我认为这个项目是什么 —— 哪里不对你再告诉我。",
    },
    project: {
      tracks: "它的工作分为",
      right: "对吗？哪里不对告诉我，我来改。在你确认之前不会写入任何内容。",
      hint: "我哪里搞错了",
      yes: "对，就是它",
      send: "发送",
    },
    goal: {
      ask: "这个项目要去往何处？",
      blurb: "任何仓库都告诉不了我的那件事。用你自己的话写一年后的样子 —— 你想要什么，接下来大致做什么。粗略、简短都行，但只能你来写。",
      guide: "什么样的目标是好目标",
      save: "保存并完成",
      later: "我稍后再写",
    },
    failed: {
      noAnswer: "Agent 结束了这一轮，但没有给出回答。",
      nothingWritten: "未写入任何内容。",
