...
const en: ConfigurationCopy = {
  ...
  navGroup: { settings: "Settings", customize: "Customize" },
  section: {
    general: "General",
    runtimes: "Runtimes",
    agents: "Workflows",
  ...
  workflows: {
    ...
    noLead: "Assign a lead before this stage can run.",
    helpers: "Helpers",
  ...
  agents: {
    ...
    roles: {
      ...
      gater: {
        ...
        trigger: "When a card turns ready",
        rule: 'Added to the end of every judgement it makes — "never pass a card that touches the database".',
        when: "a card reaches Ready to build. One it approves starts building right away; the rest go back to Not ready with one question for you.",
      },
      decider: {
        name: "Auto-answer questions",
        gloss: "Answers the questions on a card that are waiting on you.",
        trigger: "When questions wait",
        rule: 'Added to the end of every answer it gives — "when it is close, take the smaller change".',
        when: "a card is left with nothing but questions waiting on you, a sent-back delivery's included. Once it answers, the card carries on.",
        confirm: {
