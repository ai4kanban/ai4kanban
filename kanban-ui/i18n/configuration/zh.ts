  ...
  agents: {
    ...
    roles: {
      ...
      gater: {
        ...
        rule: "会附加到 Gater 每次判断的末尾——例如「动到数据库的卡片一律不放行」。",
        when: "卡片进入「可以开发」时。放行的直接进入交付，其余退回「未就绪」，并留下一个等你决定的问题。",
      },
      decider: {
        name: "代答",
      ...
      proposer: {
        ...
        rule: "会附加到 Proposer 每次回顾的末尾——例如「不要提补测试的事」。",
      ...
      sweeper: {
        name: "清卡",
        gloss: "了结那些搁置太久的卡片。",
        rule: "会附加到 Sweeper 每次判定的末尾——例如「当前版本里的卡片一律不要丢」。",
      ...
      triage: {
        ...
        note: "不建议和「放行判官」「代答」同时开着：外部来的条目可能一条人工确认都没经过，就从待筛选一路做到实施。",
      },
    },
    decider: {
