...
const zh: ConfigurationCopy = {
  ...
  runtimes: {
    ...
    notInstalled: "未安装",
    boardDefault: "看板默认",
    ownDefault: "用 CLI 自己的默认",
    loggedOut: "未登录",
    makeDefault: "设为看板默认",
    footer:
      "每个 Agent 的运行时和模型在 **Agent** 页上选，没选的用看板默认。密钥只存这台电脑。",
    keyIsBoards: "看板的密钥，存在 docs/kanban/.env——同一个连接器上的所有 Agent 共用它。",
    defaultFailed: (harness) => `未能把 ${harness} 设为看板默认`,
  },
  harness: {
    installed: "已安装",
    notInstalled: "未安装",
    ...
    advanced: "高级设置",
    advancedBlurb: "供应商、接入地址、额外参数。不填就用 CLI 自己的默认值。",
