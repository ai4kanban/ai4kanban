...
const zh: ConfigurationCopy = {
  ...
  partner: {
    ...
    consent: {
      title: "开启合作反馈",
      blurb: "帮助我们分析需求理解偏差，改进规格质量。开启后，每次是否分享仍由你在讨论中决定。",
      terms: (email) => [
        "会分享相关对话和代码，供 AI4Kanban 团队分析问题。",
        "分享的材料长期保留，用于改进规格质量。",
        "分析使用你当前配置的 AI 服务。",
        `来信 ${email} 并提供反馈编号，可以申请删除已分享的材料。`,
      ],
      warnLead: "分享包含项目代码。",
      warnRest: "相关材料会自动整理，提交前不逐项预览。",
      reversible: "可随时在配置中关闭。",
      cancel: "取消",
      confirm: "开启合作反馈",
    },
    switchOn: (name) => `${name}已开启`,
