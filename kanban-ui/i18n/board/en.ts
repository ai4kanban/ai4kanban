  ...
  create: {
    ...
    sheet: {
      ...
      guard: {
        ...
        skips: ["No refining — it starts straight from the plan", "Nothing reviews it before it reaches your branch"],
        cancel: "Cancel",
        confirm: "Start now",
      },
      plan: {
        ...
        start: "Plan tasks",
        build: "Start now",
        planHint: "Break the plan into cards and refine each one before starting",
        buildHint: "Skip refining: write a single card and start it now",
        ...
        includes: (count) => `Plan tasks includes ${count} plans`,
