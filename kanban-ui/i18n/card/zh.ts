...
const zh: CardCopy = {
  ...
  creating: {
    title: (id) => `#${id} 还在创建中`,
    blurb: "写它的那次运行结束后，这个页面才会打开。",
    unfinishedTitle: (id) => `#${id} 没有创建完`,
    unfinishedBlurb: "写它的那次运行没写完。回到看板，把那次运行接着跑完。",
    back: "回到看板",
  },
  ...
  toolbar: {
    ...
    edit: "修改",
    editHint: "打开这张卡片的聊天——说要改什么，Agent 就改写卡片",
    discussing: "讨论中",
    discussingWhy: "聊天正在回话。这一轮回话结束就解冻。",
    reviewAgain: "重新评审",
  ...
  marketing: {
    ...
    titleFailed: "标题未能保存",
    sourcePlaceholder: "从任何东西开始——一个想法、几行笔记、一个链接，或把手上的稿子贴进来。",
    discard: {
      action: "丢弃选题",
      title: "丢弃这个选题？",
      blurb: "它会永久离开看板，这里没有别的地方会删掉它。",
      keepsDrafts: "已经写下的稿件仍留在 content 文件夹里。",
      confirm: "丢弃",
      failed: "选题未能丢弃",
    },
