...
const zh: CardCopy = {
  ...
  drafts: {
    repurpose: "改写",
    repurposeHint: "以源稿为准，写出这个渠道的稿件",
    repurposeFailed: "未能启动改写",
    publish: "发布",
    publishHint: "把这个渠道标记为已发布，并记录发布地址",
    publishFailed: "未能把该渠道标记为已发布",
    notOnSource: "请选择一个渠道——源稿是各渠道稿件的依据",
    empty: "这里还没有内容。",
    unsaved: "有未保存的修改",
    movedUnderneath: "磁盘上的文件已变更——保存会覆盖它",
    replaceTitle: "替换这份稿件？",
    replaceBody: "这份稿件已经写好，你对它的修改是唯一的一份。",
    replaceConfirm: "替换",
