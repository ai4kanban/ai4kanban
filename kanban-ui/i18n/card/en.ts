...
const en: CardCopy = {
  ...
  drafts: {
    repurpose: "Repurpose",
    repurposeHint: "Write this channel's draft from the source",
    repurposeFailed: "the repurpose could not be started",
    publish: "Publish",
    publishHint: "Mark this channel published, and record where it went up",
    publishFailed: "the channel could not be marked published",
    notOnSource: "Pick a channel — the source is what they are written from",
    empty: "Nothing written here yet.",
    unsaved: "Unsaved changes",
    movedUnderneath: "Changed on disk — saving replaces it",
