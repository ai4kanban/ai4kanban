...
const en: RunsCopy = {
  action: {
    ...
    changelog: "changelog",
    setup: "setup",
    "prune-memory": "prune memory",
    "review-memory": "review chat memory",
    "review-dismissals": "learn from dismissals",
    unstick: "unstick",
    reflect: "reflect",
    triage: "triage",
    spec: "spec",
  ...
  verb: {
    ...
    setup: "setting up",
    "prune-memory": "pruning the memory",
    "review-memory": "reviewing chat memory",
    "review-dismissals": "learning from dismissals",
    unstick: "settling a card that sat too long",
  ...
  scene: {
    office: "Agent office",
    bot: (role, harness, task, state) => `${role} on ${harness} · ${task} · ${state}`,
    state: {
      running: "running",
      done: "done",
      error: "failed",
    ...
    nextRoom: "Next room",
    unavailable: "The office can't be drawn here.",
  },
  cardless: {
