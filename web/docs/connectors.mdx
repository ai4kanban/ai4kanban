...
title_tag: "AI4Kanban coding agents — Claude Code, Codex, Cursor, OpenCode, DeepSeek, ZCode"
description: "The board runs your work through one coding agent. What each of the six reports back while it works, what a run may touch, and the settings each one takes."
lead: "The board runs your work through one coding agent — Claude Code, Codex, Cursor, OpenCode, DeepSeek Harness or ZCode. All six do the work; what differs is what they report back."
