...
- **Other information you choose to provide** — the part of a card an event carries (its title, its opening paragraph, its review notes, and its questions), the decisions and answers you record against it, feedback you press send on and anything you chose to attach to it, and anything you write to us in an email.
