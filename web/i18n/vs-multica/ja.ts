...
const ja: VsMulticaCopy = {
  ...
  comparison: {
    ...
    rows: {
      ...
      execution: {
        dimension: "実行管理",
        kanban:
          "Claude Code、Codex、Cursor、OpenCode、DeepSeek Harness でカードを実行し、提案からアーカイブまでの状態を管理。",
        multica:
  ...
  wins: {
    ...
    theirs: {
      ...
      runtimeReach: {
        title: "幅広いランタイム対応",
        body: "ローカルdaemonから多様なエージェントCLIに接続できます。AI4Kanbanは現在、Claude Code、Codex、Cursor、OpenCode、DeepSeek Harness に対応しています。",
      },
    },
  },
  decision: {
