...
const zh: VsMulticaCopy = {
  ...
  hero: {
    ...
    oursDiagramAlt: "AI4Kanban 让人和智能体围绕项目目标共同规划和执行。",
    theirsDiagramAlt: "Multica 让用户配置和运营多个智能体。",
    oursDiagramTop: "人给方向 · 做关键判断",
    oursDiagramBottom: "智能体规划 · 澄清 · 执行",
    theirsDiagramTop: "多个智能体 + Skills + 运行时",
    theirsDiagramBottom: "分工 · 调度 · 协作 · 监控",
  },
  boundary: {
  ...
  comparison: {
    ...
    rows: {
      ...
      execution: {
        dimension: "执行管理",
        kanban: "可以启动 Claude Code 或 Codex 执行卡片，并管理任务从提出到归档的完整状态。",
  ...
  wins: {
    ...
    theirs: {
      ...
      runtimeReach: {
        title: "支持更多智能体运行环境",
        body: "可通过本地守护进程连接多种智能体 CLI；AI4Kanban 目前支持 Claude Code 和 Codex。",
      },
    },
  },
  decision: {
