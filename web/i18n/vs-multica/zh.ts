...
const zh: VsMulticaCopy = {
  ...
  comparison: {
    ...
    rows: {
      ...
      execution: {
        dimension: "执行管理",
        kanban: "可以启动 Claude Code、Codex、Cursor、OpenCode、DeepSeek Harness 或 DeepSeek Harness 执行卡片，并管理任务从提出到归档的完整状态。",
  ...
  wins: {
    ...
    theirs: {
      ...
      runtimeReach: {
        title: "支持更多智能体运行环境",
        body: "可通过本地守护进程连接多种智能体 CLI；AI4Kanban 目前支持 Claude Code、Codex、Cursor、OpenCode、DeepSeek Harness 和 DeepSeek Harness。",
      },
    },
  },
  decision: {
