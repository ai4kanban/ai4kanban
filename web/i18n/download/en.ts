...
const en: DownloadCopy = {
  ...
  command: {
    ...
    later: "Skip it and the button waits in **Configuration → General**. Linux is not offered it: the AppImage unpacks somewhere new every run, so `npm install -g ai4kanban` stays the way.",
  },
};
