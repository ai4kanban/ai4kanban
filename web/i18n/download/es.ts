...
const es: DownloadCopy = {
  ...
  command: {
    ...
    later: "Si dices que no, el botón te espera en **Configuration → General**. En Linux no se ofrece: el AppImage se descomprime en un sitio nuevo cada vez, así que `npm install -g ai4kanban` sigue siendo el camino.",
  },
};
