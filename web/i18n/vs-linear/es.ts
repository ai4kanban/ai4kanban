  ...
  comparison: {
    ...
    rows: {
      ...
      agentModel: {
        ...
        kanban: "El entorno de programación que elijas lee y escribe el tablero; actualmente se admiten Claude Code y Codex.",
  ...
  wins: {
    ...
    ours: {
      ...
      anyHarness: {
        ...
        body: "El tablero no está ligado a un runtime de agentes propietario. Claude Code y Codex ya son compatibles, y el formato de archivo abierto permite utilizar otros entornos.",
      },
      noSaas: {
