...
const zh: VsLinearCopy = {
  ...
  comparison: {
    ...
    rows: {
      ...
      agentModel: {
        dimension: "智能体模式",
        kanban: "由你选择的编码运行环境读写看板，目前支持 Claude Code、Codex、Cursor、OpenCode、DeepSeek Harness 和 DeepSeek Harness。",
  ...
  wins: {
    ...
    ours: {
      ...
      anyHarness: {
        title: "自行选择编码环境",
        body: "目前支持 Claude Code、Codex、Cursor、OpenCode、DeepSeek Harness 和 DeepSeek Harness，不绑定专有运行时。",
      },
      noSaas: {
        title: "无需额外服务",
