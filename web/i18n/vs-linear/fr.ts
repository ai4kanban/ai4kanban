  ...
  comparison: {
    ...
    rows: {
      ...
      agentModel: {
        ...
        kanban: "L’environnement de code de votre choix lit et écrit le tableau ; Claude Code, Codex, Cursor, OpenCode et DeepSeek Harness sont actuellement pris en charge.",
  ...
  wins: {
    ...
    ours: {
      ...
      anyHarness: {
        ...
        body: "Le tableau n’est pas lié à un runtime d’agent propriétaire. Claude Code, Codex, Cursor, OpenCode et DeepSeek Harness sont déjà pris en charge, et le format de fichier ouvert permet d’utiliser d’autres environnements.",
      },
      noSaas: {
