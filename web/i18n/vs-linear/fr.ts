  ...
  comparison: {
    ...
    rows: {
      ...
      agentModel: {
        ...
        kanban: "L’environnement de code de votre choix lit et écrit le tableau ; Claude Code, Codex, Cursor, OpenCode, DeepSeek Harness, ZCode et Grok Build sont actuellement pris en charge.",
      ...
      portfolio: {
        ...
        kanban: "Cartes, dépendances, priorités, ROI, releases et mémoire de planification.",
  ...
  wins: {
    ...
    ours: {
      ...
      anyHarness: {
        ...
        body: "Le tableau n’est pas lié à un runtime d’agent propriétaire. Claude Code, Codex, Cursor, OpenCode, DeepSeek Harness, ZCode et Grok Build sont déjà pris en charge, et le format de fichier ouvert permet d’utiliser d’autres environnements.",
      },
      noSaas: {
