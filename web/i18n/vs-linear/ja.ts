  ...
  comparison: {
    ...
    rows: {
      ...
      agentModel: {
        ...
        kanban: "選択したコーディング環境がボードを読み書きします。現在は Claude Code、Codex、Cursor、OpenCode、DeepSeek Harness、ZCode に対応しています。",
  ...
  wins: {
    ...
    ours: {
      ...
      anyHarness: {
        ...
        body: "ボードは独自のエージェントランタイムに縛られません。現在は Claude Code、Codex、Cursor、OpenCode、DeepSeek Harness、ZCode に対応し、オープンなファイル形式は他の環境でも利用できます。",
      },
      noSaas: {
