  ...
  comparison: {
    ...
    rows: {
      ...
      agentModel: {
        ...
        kanban: "Your coding harness reads and writes the board; Claude Code and Codex are supported today.",
  ...
  wins: {
    ...
    ours: {
      ...
      anyHarness: {
        ...
        body: "The board is not tied to a proprietary agent runtime. Claude Code and Codex are supported today, and the open file format can work with other harnesses.",
      },
      noSaas: {
