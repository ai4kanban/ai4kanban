  ...
  comparison: {
    ...
    rows: {
      ...
      agentModel: {
        ...
        kanban: "Your coding harness reads and writes the board; Claude Code, Codex, Cursor, OpenCode, and DeepSeek Harness are supported today.",
  ...
  wins: {
    ...
    ours: {
      ...
      anyHarness: {
        ...
        body: "The board is not tied to a proprietary agent runtime. Claude Code, Codex, Cursor, OpenCode, and DeepSeek Harness are supported today, and the open file format can work with other harnesses.",
      },
      noSaas: {
