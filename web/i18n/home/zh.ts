...
const zh: HomeCopy = {
  ...
  loop: {
    ...
    steps: [
      {
        title: "明确任务与依赖",
        body: "结合目标、代码和模块记忆，判断接下来该做什么，并把大目标拆分为边界清晰的卡片；依赖关系决定哪些任务可以并行、哪些必须等待。",
      },
      {
        title: "澄清需求",
      ...
      {
        title: "推进执行",
        body: "需求明确到可以开工后，Agent 按任务中写明的范围和步骤推进。一个看板可以同时管理十个以上开发任务；每次交付都使用独立的 Git worktree，落地前若发生冲突则触发专门的解冲突流程。",
      },
      {
        title: "在实施前完成关键决策",
        body: "Spec Agents 会在实施前阅读代码并研究外部依赖。遇到 UI 改动时，它还可以把多套可运行的 mockup 放入卡片，让你在编写代码前确定实现方向。",
      },
      {
        title: "仅在必要时请求审批",
        body: "Agent 会在后台持续澄清需求并推进开发。仅当产品取舍或验收需要人工确认时，AI4Kanban 才发送卡片通知；确认后，任务会在对应项目机器上继续执行直至交付。",
      },
    ],
  },
