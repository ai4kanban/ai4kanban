...
const zh: HomeCopy = {
  meta: {
    ...
    schema:
      "AI4Kanban 是开源、本地优先的 AI 项目经理，帮助独立创业者、创作者和小团队通过 Agent 团队推进更大的项目。它安排任务、跟进执行，并在开发工作流中评审成果；你掌握方向、关键决策和最终验收。目前内置产品开发和产品视频工作流，可通过添加工作流与 Agent 扩展到其他工作。",
  },
  ...
  loop: {
    ...
    steps: [
      ...
      {
        title: "哪些工作自动进行，由你决定。",
        body: "有些工作由你随时发起：聊一聊想法、整理看板、纠正跑偏的方案。「回顾对话记忆」默认开着，每天自动跑一次。其余几项要你开启后才会自动进行：批准交付、回答待定问题、提出后续工作。每一项都可以单独选择运行工具和模型，并写下你的要求。",
      },
    ],
  },
