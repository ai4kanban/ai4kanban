  ...
  comparison: {
    ...
    rows: {
      ...
      reach: {
        ...
        kanban:
          "Claude Code, Codex, Cursor, OpenCode, DeepSeek Harness et ZCode aujourd’hui. Le tableau n’est que des fichiers : un autre harnais n’a pas besoin d’un nouveau format, seulement d’un branchement.",
        taskMaster:
