...
const ja: VsTaskMasterCopy = {
  ...
  comparison: {
    ...
    rows: {
      ...
      memory: {
        dimension: "何が引き継がれるか",
        kanban:
          "計画のための記憶：決定、却下した案、設計の修正、出荷した仕事。エージェントごとに保存され、次の提案の前に読まれるので、一度の「いいえ」は「いいえ」のままです。",
        taskMaster:
      ...
      reach: {
        dimension: "どこで動くか",
        kanban:
          "現時点では Claude Code、Codex、Cursor、OpenCode、DeepSeek Harness、ZCode、Grok Build。ボードはただのファイルなので、別のハーネスでも新しい形式は不要で、つなぐだけです。",
        taskMaster:
  ...
  wins: {
    ...
    ours: {
      ...
      remembers: {
        title: "却下したことを覚えている",
        body: "決定、却下した案、設計の修正はプランナー自身の記憶に置かれ、次の提案の前に読まれます。だからボードは同じ提案を二度しません。",
      },
      nothingToWire: {
        title: "立ち上げるものがない",
