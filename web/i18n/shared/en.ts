// English copy for the chrome every page shares — the source of truth the other four
...
const en: SharedCopy = {
  ...
  footer: {
    ...
    launchkiwi: "AI4Kanban featured on LaunchKiwi",
    verifieddr: "AI4Kanban's domain rating page on VerifiedDR",
    x: "Tao Wu on X",
  },
  code: {
    copy: "Copy",
