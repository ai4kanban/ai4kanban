...
| Modules | Which product areas the card changes, and which memory topics apply |
...
Project memory carries forward shipped behavior, current decisions, rejected directions, and design lessons. Later cards receive that memory instead of replaying every earlier conversation.
...
<MemoryShot
  ...
  caption="Cards keep task-specific decisions; compact project memory carries reusable decisions into future work."
/>
