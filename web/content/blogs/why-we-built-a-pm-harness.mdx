...
excerpt: "AI4Kanban is a PM harness. In our own development work, it prepared tasks for coding agents, preserved product decisions, and asked for human judgment only when it mattered."
date: 2026-08-21
...
![A design proposal on AI4Kanban card #154, where the UI designer agent compares three card-page layouts and presents the first as a working mockup.](https://cdn.ai4kanban.dev/blog-pm-harness-design-proposal.webp)
