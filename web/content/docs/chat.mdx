...
| a preference or a correction that outlasts this card | it saves it to the board's memory |
| the card worked out, or the code written | the skill does its printed flow here unless you ask for a background run |

On a card, it works your message out turn by turn: a change goes into the card, an answer settles
one of its open questions, and anything you settle that outlasts the card goes into the board's
memory so later planning reads it. Say to hold off, or not to record it, and it does neither.
