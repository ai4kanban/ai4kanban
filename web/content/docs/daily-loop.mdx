...
- **The review is optional.** It is a separate paid run on every delivery, so the **Reviewer**'s
  switch on Configuration → Agents turns it off for the board. The build then goes straight to
  landing; your own checks, the open-question hold and **Approve diffs before landing** still
  gate it.
