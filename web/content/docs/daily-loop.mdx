...
- **A workflow that makes files gets no branch.** Product video, Slide deck, and any workflow of
  ...
  to your tracked files outside the board stops it instead. A Product video skips build and
  review altogether: it is made while planning, and you **Archive** the card to accept it.
