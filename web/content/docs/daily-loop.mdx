...
**Gater** in Configuration → Agents replaces that press. It is off by default. With it on,
...
`rejected.md` on top of the card, and it runs on its own tool and model, set on its row in
